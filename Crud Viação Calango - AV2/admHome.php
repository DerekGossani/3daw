...
<head>
    ...
    <link rel="stylesheet" href="styleFuncHome.css">
</head>
<body>
    <div class="container">
        <div class="section" id="gerenciar-onibus">
            ...
            <button onclick="window.location.href='crudOnibus.php'">Gerenciar Ônibus</button>
        </div>
        <div class="section" id="gerenciar-funcionarios">
            <h2>Gerenciar Funcionários</h2>
            <div id="funcionarios-list"></div>
            <button onclick="window.location.href='crudFunc.php'">Gerenciar Funcionários</button>
        </div>
    </div>
